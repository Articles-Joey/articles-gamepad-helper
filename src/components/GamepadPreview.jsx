...
import '../styles/components/GamepadPreview.scss';
...
const GamepadPreview = ({ 
    ...
    return (
        <div
            ...
            {(showPreview && controllerState?.axes) &&
                <svg width="100%" viewBox="0 0 441 383" fill="none"
                    ...
                    <g id="XBox">
                        ...
                        <circle id="LeftStick" cx="114.20064087891966" cy="157.38173495078965" r="28" fill={`rgba(0,0,0,${Math.max(Math.abs(controllerState?.axes[0]), Math.abs(controllerState?.axes[1]))})`} stroke="rgba(0,0,0,1)" stroke-width="3"></circle>

                        <circle id="RStickOutline" cx="278" cy="238" r="37.5" stroke="hsl(210,50%,85%)" stroke-opacity="1" stroke-width="3"></circle>
                        <circle id="RightStick" cx="277.915953307393" cy="239.06916914625774" r="28" fill={`rgba(0,0,0,${Math.max(Math.abs(controllerState?.axes[2]), Math.abs(controllerState?.axes[3]))})`} stroke="rgba(0,0,0,1)" stroke-width="3"></circle>

                        <circle id="DOutline" cx="166" cy="238" r="37.5" stroke="hsl(210,50%,85%)" stroke-opacity="1" stroke-width="3"></circle>

                        <g id="DUp">
                            {!controllerState?.buttons[12].pressed && <mask id="path-8-inside-1" fill="white">
                        ...
                        <g id="DRight">
                            {!controllerState?.buttons[15].pressed && <mask id="path-9-inside-2" fill="white">
                        ...
                        <g id="DDown">
                            {!controllerState?.buttons[13].pressed && <mask id="path-10-inside-3" fill="white">
                        ...
                        <g id="DLeft">
                            {!controllerState?.buttons[14].pressed && <mask id="path-11-inside-4" fill="white">
                        ...
                        <g id="BTop">
                            {!controllerState?.buttons[3].pressed && <mask id="path-13-inside-5" fill="white">
                        ...
                        <g id="BRight">
                            {!controllerState?.buttons[1].pressed && <mask id="path-14-inside-6" fill="white">
                        ...
                        <g id="BBottom">
                            {!controllerState?.buttons[0].pressed && <mask id="path-15-inside-7" fill={'white'}>
                        ...
                        <g id="BLeft">
                            {!controllerState?.buttons[2].pressed && <mask id="path-16-inside-8" fill="white">
                        ...
                        <g id="LPressure">
                            <defs>
                                <linearGradient id="grad1" x1="0%" x2="100%" y1="0%" y2="0%">
                                    <stop offset={`${Math.abs(controllerState?.axes[0] * 100)}%`} stop-color="yellow" />
                                    <stop offset="100%" stop-color="red" />
                                </linearGradient>
                            </defs>
                            {/* <ellipse cx="100" cy="70" rx="85" ry="55" fill="url(#grad1)" /> */}
                            <rect id="R1" x="35" y="150" width="41" height="13" rx="6.5" fill="url(#grad1)" stroke-width="3"></rect>
                            {/* <circle cx="155" cy="162" r="10" fill={controllerState?.buttons[8].pressed ? 'rgba(0,0,0,1)' : 'rgba(0,0,0,0)'} stroke="rgba(0,0,0,1)" stroke-width="3"></circle> */}
                        </g>

                        <g id="LPressure">
                            <defs>
                                <linearGradient id="grad2" x1="0%" x2="000%" y1="0%" y2="100%">
                                    <stop offset={`${Math.abs(controllerState?.axes[1] * 100)}%`} stop-color="yellow" />
                                    <stop offset="100%" stop-color="red" />
                                </linearGradient>
                            </defs>
                            <rect id="R1" x="15" y="137" width="13" height="41" rx="6.5" fill="url(#grad2)" stroke-width="3"></rect>
                        </g>

                        {/* Back Button */}
                        <g id="LMeta">
                            <circle cx="185" cy="162" r="10" fill={controllerState?.buttons[8].pressed ? 'rgba(0,0,0,1)' : 'rgba(0,0,0,0)'} stroke="rgba(0,0,0,1)" stroke-width="3"></circle>
                        </g>

                        {/* Start Button */}
                        <g id="RMeta">
                            <circle cx="259" cy="162" r="10" fill={controllerState?.buttons[9].pressed ? 'rgba(0,0,0,1)' : 'rgba(0,0,0,0)'} stroke="rgba(0,0,0,1)" stroke-width="3"></circle>
                        </g>

                        {!controllerState?.buttons[4].pressed &&
                            <rect id="L1" x="111.5" y="61.5" width="41" height="13" rx="6.5" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="3"></rect>
                        }
                        {!controllerState?.buttons[5].pressed &&
                            <rect id="R1" x="289.5" y="61.5" width="41" height="13" rx="6.5" fill="rgba(0,0,0,0)" stroke="rgba(0,0,0,1)" stroke-width="3"></rect>
                        }
                        {!controllerState?.buttons[6].pressed &&
                        ...
                        {!controllerState?.buttons[7].pressed &&
...
export default memo(GamepadPreview);